  ...
  return (
    <div className="min-h-screen bg-gray-600">
      <header className="bg-white shadow">
        ...
        <h1 className="text-4xl font-extrabold text-gray-900 shadow-lg">Dashboard</h1>
          <div className="flex items-center space-x-4">
            <span className="text-3xl font-semibold text-gray-900 shadow-md">Welcome, {user.name}</span>
              <form action={async () => {
              'use server';
